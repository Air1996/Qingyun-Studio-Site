      ...
      <ArcoLayout style={{ minHeight: "100vh" }}>
        <Header>
          ...
          >
            ...
            <MenuItem key="2">商店</MenuItem>
            <MenuItem key="3">论坛</MenuItem>
        ...
        <Content style={{ flex: 1 }} className="dark:bg-gray-800">
          {children}
        </Content>
        <Footer>
          {/* <div className="px-8 py-10 text-center bg-slate-400">
            <span className="text-white">
              Copyright &copy; 2023 QingyunStudio. All rights reserved.
            </span>
          </div> */}
          <footer className="px-4 divide-y dark:bg-gray-800 dark:text-gray-100">
            ...
            <div className="py-6 text-sm text-center dark:text-gray-400">
              © 2023 QingYun Studio. All rights reserved.
            </div>
          </footer>
        </Footer>
      </ArcoLayout>
